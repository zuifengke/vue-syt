<template>
  <div class="detail">
    ...
    <div class="logo">
      <div class="left">
        <img
          :src="`data:image/jpeg;base64,${hospDetailStore.hospitalInfo.hospital?.logoData}`"
          alt=""
        />
      </div>
      <div class="right">
        ...
        <div class="route">
          规划路线:{{ hospDetailStore.hospitalInfo.hospital?.route }}
        </div>
      </div>
    </div>
    <!-- 医院介绍 -->
    <div class="footer">
      <h1>医院介绍</h1>
      <p>
        {{ hospDetailStore.hospitalInfo.hospital?.intro }}
      </p>
    </div>
  </div>
</template>
